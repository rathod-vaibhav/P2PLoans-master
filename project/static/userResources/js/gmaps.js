...
*/
    ...
    var array_map = function (array, callback) {
        var original_callback_params = Array.prototype.slice.call(arguments, 2), array_return = [],
            array_length = array.length, i;
    ...
    var GMaps = (function (global) {
        ...
        var GMaps = function (options) {
            ...
            var self = this, i,
                ...
                identifier = options.el || options.div, markerClustererFunction = options.markerClusterer,
                ...
                overviewMapControl = valueOrDefault(overviewMapControl, true), map_options = {},
                map_base_options = {zoom: this.zoom, center: map_center, mapTypeId: mapType}, map_controls_options = {
            ...
            var buildContextMenuHTML = function (control, e) {
                ...
                var context_menu_items = context_menu_element.getElementsByTagName('a'),
                    context_menu_items_count = context_menu_items.length, i;
                ...
                var position = findAbsolutePosition.apply(this, [self.el]), left = position[0] + e.pixel.x - 15,
    ...
    GMaps.prototype.createMarker = function (options) {
        ...
        var self = this, details = options.details, fences = options.fences, outside = options.outside,
    ...
    GMaps.prototype.drawOverlay = function (options) {
        ...
        overlay.onAdd = function () {
            ...
            var panes = this.getPanes(), overlayLayer = panes[options.layer],
        ...
        overlay.draw = function () {
            ...
            var el = overlay.el, content = el.children[0], content_height = content.clientHeight,
