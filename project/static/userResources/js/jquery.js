...
(function (global, factory) {
    ...
    var support = {};
    var
        version = "1.12.3", jQuery = function (selector, context) {
...
*/(function (window) {
    ...
    jQuery.event = {
        global: {}, add: function (elem, types, handler, data, selector) {
            ...
            "metaKey relatedTarget shiftKey target timeStamp view which").split(" "), fixHooks: {}, keyHooks: {
            ...
            props: ("button buttons clientX clientY fromElement offsetX offsetY " +
                "pageX pageY screenX screenY toElement").split(" "), filter: function (event, original) {
